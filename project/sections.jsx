      ...
      <div className="wrap">
        <div className="s-head reveal" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: 48, justifyContent: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <h2 className="display s-title" style={{ marginTop: 0, color: 'var(--teal-deep)', fontWeight: 500 }}>Customer Voices</h2>
          </div>
        ...
        <div className="testimonials">
          {IRHA.TESTIMONIALS.map((t, i) => {
            ...
            return (
              <div className="t-card reveal" key={i} style={{ flex: '0 0 min(340px, 85vw)', scrollSnapAlign: 'start', position: 'relative', padding: '26px 26px 48px 26px', background: '#fff', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-soft)', display: 'flex', flexDirection: 'column', gap: 16 }}>
