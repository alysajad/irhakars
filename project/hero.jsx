        ...
        <div className="mobile-menu-overlay" onClick={closeMenu}>
          <div className="mobile-menu" onClick={e => e.stopPropagation()}>
            ...
            <div className="mobile-menu-links">
              ...
              <a href="#routes" onClick={closeMenu}>Routes</a>
              <a href="#packages" onClick={closeMenu}>Packages</a>
              <a href="#drivers" onClick={closeMenu}>Drivers</a>
              <a href="#team" onClick={closeMenu}>Team</a>
              <a href="#b2b" onClick={closeMenu}>For Operators</a>
...
function Hero(){
  ...
  return (
    <section className="hero" id="home">
      {/* Kashmir mountain photo background — multiple fallbacks */}
        ...
        <img
          ...
          onError={(e) => {
            if (!e.currentTarget.dataset.fallback) {
              ...
              e.currentTarget.src = 'https://images.unsplash.com/photo-1566837945700-30057527ade0?w=1920&q=80&auto=format';
            } else {
        ...
        <div className="hero-inner">
          <div className="hero-content">
            ...
            <div className="hero-price-badge">
              <div className="badge-price">₹1,800<small>/day</small></div>
              <div className="badge-label">Starting from · Driver included</div>
            </div>
